...
export default function ThemeToggle() {
  ...
  useEffect(() => { const saved = localStorage.getItem("theme") as Theme | null; const next = saved ?? (window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"); setTheme(next); applyTheme(next); }, []);
