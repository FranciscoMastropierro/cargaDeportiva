...
export const metadata: Metadata = { title: "Control de Carga de Jugadores", description: "Registro de minutos y Borg para fútbol", applicationName: "Control de Carga de Jugadores", icons: { icon: "/icon.svg", apple: "/icon.svg" } };
